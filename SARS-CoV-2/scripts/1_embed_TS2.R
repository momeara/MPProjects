...
cell_feature_columns <- readr::read_tsv(
    "raw_data/cell_feature_columns_TS_202008.tsv")

cell_metadata_columns <- readr::read_tsv(
    "raw_data/cell_metadata_columns_TS_202008.tsv")
...
cell_features_2M %>%
    arrow::write_parquet(
        sink = "product/covid19cq1_SARS_TS2_2M_Cell_MasterDataTable.parquet")
...
system("
        ...
        /home/ubuntu/anaconda3/envs/sextonlab/bin/python \\
            ...
            --dataset /home/ubuntu/projects/SARS-CoV-2/product/covid19cq1_SARS_TS2_2M_Cell_MasterDataTable.parquet \\
            --tag UMAP_embedding_TS2_2M_epochs=2000_20200901 \\
            --feature_columns ~/projects/SARS-CoV-2/raw_data/cell_feature_columns_TS_202008.tsv \\
...
cell_features %>%
    arrow::write_parquet(
        sink = "product/covid19cq1_SARS_TS2_plate_scaled_Cell_MasterDataTable.parquet")
...
system("
        ...
        /home/ubuntu/anaconda3/envs/sextonlab/bin/python \\
            ...
            --dataset /home/ubuntu/projects/SARS-CoV-2/product/covid19cq1_SARS_TS2_plate_scaled_Cell_MasterDataTable.parquet \\
            --tag UMAP_embedding_into_TS2_2M_epochs=2000_20200901 \\
            --feature_columns /home/ubuntu/projects/SARS-CoV-2/raw_data/cell_feature_columns_TS_202008.tsv \\
            --no_standardize_features \\
...
cell_features <- dplyr::bind_cols(
    arrow::read_parquet(
        file = "product/covid19cq1_SARS_TS2_2M_Cell_MasterDataTable.parquet"),
    arrow::read_parquet(
        file = "~/opt/MPLearn/vignettes/SARS-CoV-2/S25/intermediate_data/UMAP_embedding_TS2_2M_epochs=2000_20200901/umap_embedding.parquet"))

#cell_features <- cell_features %>%
#    dplyr::sample_n(2000000)
...
all_cds %>% MPStats::serialize_clusters(
    output_fname = "~/opt/MPLearn/vignettes/SARS-CoV-2/S25/intermediate_data/UMAP_embedding_TS2_2M_epochs=2000_20200901/clusters_leiden_k=15_res=1e-5.parquet")
