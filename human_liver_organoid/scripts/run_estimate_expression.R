...
timing <- system.time({
	estimate_expression(
		...
		reference_genome_path = parameters$reference_genome_path,
		fastq_dump_program = parameters$fastq_dump_program,
		rsem_calculate_expression_program = parameters$rsem_calculate_expression_program,
